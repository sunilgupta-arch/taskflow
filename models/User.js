...
class UserModel {
  ...
  static async update(id, data) {
    ...
    const allowedFields = ['name', 'email', 'organization_id', 'role_id', 'weekly_off_day', 'shift_start', 'shift_hours', 'leave_status', 'is_active', 'avatar', 'visible_to_client', 'is_developer', 'is_archived'];
  ...
  static async getAll({ org_type, role_id, is_active, search, page = 1, limit = 20 } = {}) {
    ...
    const [rows] = await db.query(
      `SELECT u.id, u.name, u.email, u.organization_id, u.role_id, u.weekly_off_day, u.shift_start, u.shift_hours, u.leave_status, u.is_active, u.visible_to_client, u.is_archived, u.created_at,
